...
export default {
    mounted() {
        ...
        const daytimeBackground = document.querySelectorAll(".daytime-backgrond");
        const cloud = document.querySelector(".cloud");
        const cloudLight = document.querySelector(".cloud-light");
        ...
        mainButton.addEventListener("click", () => {
            if (isMoved) {
                ...
                daytimeBackground.forEach((background) => {
                ...
                daytimeBackground.forEach((background) => {
                    background.style.transform = "translateX(110px)";
                });
        ...
        mainButton.addEventListener("mousemove", () => {
            ...
            if (isMoved) {
                ...
                daytimeBackground.forEach((background) => {
                    background.style.transform = "translateX(100px)";
                });
            } else {
                mainButton.style.transform = "translateX(10px)";
                daytimeBackground.forEach((background) => {
                    background.style.transform = "translateX(10px)";
                });
            }
        });
